...
#define TSK_TI_PREEMPT 72 /* offsetof(struct task_struct, thread_info.preempt_count) */
#define TSK_TI_ADDR_LIMIT 64 /* offsetof(struct task_struct, thread_info.addr_limit) */
#define TSK_STACK 88 /* offsetof(struct task_struct, stack) */

#define THREAD_CPU_CONTEXT 2192 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define TRAMP_VALIAS -279198060544 /* TRAMP_VALIAS */
